...
!http://media.chikuyonok.ru/xv/overview.png!
...
* "Safari for Mac extension":https://github.com/sergeche/xmlview/downloads (via Marc Liyanage’s "webkit-xmlview-plugin":https://github.com/liyanage/webkit-xmlview-plugin plugin)
